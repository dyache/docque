...
from src.staff.service import StaffService, StaffServiceDep, oauth2_scheme
...
async def get_me(staff_serv: StaffServiceDep, auth: HTTPAuthorizationCredentials = Security(oauth2_scheme)) -> StaffSchema:
    try:
